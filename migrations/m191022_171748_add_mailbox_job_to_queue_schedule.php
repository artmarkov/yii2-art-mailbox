...
class m191022_171748_add_mailbox_job_to_queue_schedule extends Migration
{
    public function up()
    {
       ...
       $this->insert('{{%queue_schedule}}', ['class' => 'artsoft\mailbox\jobs\TrashMailJob', 'title' => 'Очистка всех корзин', 'content' => 'Очищает корзины всех пользователей', 'cron_expression' => '0 0 1 */6 *', 'priority' => 1024 ,'created_at' => time(), 'updated_at' => time(), 'created_by' => 1, 'updated_by' => 1]);
    }
    ...
    public function down()
    {
        ...
        $this->delete('{{%queue_schedule}}', ['class' => 'artsoft\mailbox\jobs\TrashMailJob']);
    }
}
