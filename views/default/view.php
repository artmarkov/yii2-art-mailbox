        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <p>
                        <?=
                        Html::a(Yii::t('art', 'Edit'), ['/mailbox/default/update', 'id' => $model->id], ['class' => 'btn btn-sm btn-primary'])
                        ?>
                        <?=
                        ...
                        ?>
                        <?=
                        Html::a(Yii::t('art', 'Add New'), ['/mailbox/default/create'], ['class' => 'btn btn-sm btn-success pull-right'])
                        ?>
                    </p>
